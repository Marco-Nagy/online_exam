...
class _ApiManager implements ApiManager {
  ...
  Future<ForgotPasswordResponse> forgotPassword(
      ForgetPasswordRequest body) async {
  ...
  @override
  Future<AuthResponse> resetPassword(ResetPasswordRequest body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<AuthResponse> signIn(SignInRequest user) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<AuthResponse> signUp(RegisterRequest user) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<ExamResponseModel> getExamsBySubjectId(String subjectId) async {
    final _extra = <String, dynamic>{};
  ...
  @override
  Future<QuestionsSubjectModel> getQuestionsByExamId(String examId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'exam': examId};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<QuestionsSubjectModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late QuestionsSubjectModel _value;
    try {
      _value = QuestionsSubjectModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
